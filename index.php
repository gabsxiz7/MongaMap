...
<section class="qr-code-section">
  <div class="container">
      ...
      <p>Escaneie o QR Code abaixo e descubra surpresas especiais no MongaMap.</p>
      <div class="qr-code-container">
          <img src="IMG/qrcode.png" alt="QR Code para recompensas" />
      </div>
      <p><strong>Abra sua câmera, escaneie e aproveite!</strong></p>
  </div>
</section>
<footer class="footer">
